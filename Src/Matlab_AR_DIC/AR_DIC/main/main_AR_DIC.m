...
endframe=10; %last video frame to analyze
%Match path to operating system '\' on Windows and '/' on Unix-based systems
folderpath_win='D:\Data\aoy\';%set DIC output folder
folderpath='D:\\Data\\aoy\\';%DIC output folder formatted for ImageJ %placing \\ after folder important
vidpath='D:\\Data\\aoy\\videos\\137P31 ASO_1.avi'; %video to analyze
